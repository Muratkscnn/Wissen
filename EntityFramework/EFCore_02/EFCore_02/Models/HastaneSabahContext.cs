...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Bolumler>(entity =>
            {
                ...
                entity.HasIndex(e => e.BolumAd, "UQ__Bolumler__7BD2881BAB06E1B4")
                    .IsUnique();
            ...
            modelBuilder.Entity<Doktorlar>(entity =>
            {
                ...
                entity.HasIndex(e => e.SicilNo, "UQ__Doktorla__B736D3C2A9C6EE77")
                    .IsUnique();
            ...
            modelBuilder.Entity<Hastalar>(entity =>
            {
                ...
                entity.HasIndex(e => e.TcNo, "UQ__Hastalar__8EF935A6FE3BB203")
                    .IsUnique();
