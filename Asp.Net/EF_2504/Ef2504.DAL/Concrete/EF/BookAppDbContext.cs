using Ef2504.DAL.Concrete.EF.Config;
...
namespace Ef2504.DAL.Concrete.EF
{
    public class BookAppDbContext :DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            //var olan configlerimizden herhangibirini seçip onun tipini alıyor ve o tipteki tüm configlerin uygulanmasını sağlıyoruz
