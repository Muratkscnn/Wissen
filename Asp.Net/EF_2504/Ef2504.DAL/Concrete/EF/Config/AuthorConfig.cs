...
namespace Ef2504.DAL.Concrete.EF.Config
{
    public class AuthorConfig : IEntityTypeConfiguration<Author>
    {
        public void Configure(EntityTypeBuilder<Author> builder)
        {
            ...
            builder.HasData(
                new Author { AuthorId = 1, AuthorFirstName= "Murat", AuthorLastName = "Kuşcan"},
                new Author { AuthorId = 2, AuthorFirstName = "Berkay", AuthorLastName = "Emir"},
                new Author { AuthorId = 3, AuthorFirstName = "Ahmet", AuthorLastName = "K."}
