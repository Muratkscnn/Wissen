...
namespace Ef2504.DAL.Migrations
{
    ...
    [Migration("20220425115556_migRelation")]
            ...
            modelBuilder.Entity("Ef2504.DAL.Entities.Author", b =>
                {
                    ...
                    b.Property<DateTime>("AuthorCreatedDate")
                        ...
                        .HasDefaultValue(new DateTime(2022, 4, 25, 14, 55, 55, 544, DateTimeKind.Local).AddTicks(8274));
            ...
            modelBuilder.Entity("Ef2504.DAL.Entities.Book", b =>
                {
                    ...
                    b.Property<DateTime>("BookCreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 4, 25, 14, 55, 55, 564, DateTimeKind.Local).AddTicks(478));
