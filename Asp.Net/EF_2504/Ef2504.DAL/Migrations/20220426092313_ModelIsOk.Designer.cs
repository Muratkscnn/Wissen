...
namespace Ef2504.DAL.Migrations
{
    ...
    [Migration("20220426092313_ModelIsOk")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ef2504.DAL.Entities.Author", b =>
                {
                    ...
                    b.Property<DateTime>("AuthorCreatedDate")
                        ...
                        .HasDefaultValue(new DateTime(2022, 4, 26, 12, 23, 11, 551, DateTimeKind.Local).AddTicks(8030));
            ...
            modelBuilder.Entity("Ef2504.DAL.Entities.Book", b =>
                {
                    ...
                    b.Property<DateTime>("BookCreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 4, 26, 12, 23, 11, 608, DateTimeKind.Local).AddTicks(2593));
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BookImageUrl = "https://productimages.hepsiburada.net/s/8/375/8797179248690.jpg",
            ...
            modelBuilder.Entity("Ef2504.DAL.Entities.BookAuthor", b =>
                {
            ...
            modelBuilder.Entity("Ef2504.DAL.Entities.Book", b =>
                {
                    b.HasOne("Ef2504.DAL.Entities.Category", "Category")
                        .WithMany("Books")
            ...
            modelBuilder.Entity("Ef2504.DAL.Entities.BookAuthor", b =>
                {
                    b.HasOne("Ef2504.DAL.Entities.Author", "Author")
                        .WithMany("BookAuthor")
                        .HasForeignKey("AuthorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Ef2504.DAL.Entities.Book", "Book")
                        .WithMany("BookAuthor")
            ...
            modelBuilder.Entity("Ef2504.DAL.Entities.BookDetail", b =>
                {
                    b.HasOne("Ef2504.DAL.Entities.Book", "Book")
                        .WithOne("BookDetail")
                        .HasForeignKey("Ef2504.DAL.Entities.BookDetail", "BookId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
